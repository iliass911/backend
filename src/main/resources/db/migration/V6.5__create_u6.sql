...
CREATE TABLE `u6` (
  ...
  `temps_darret` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `u6`
--

LOCK TABLES `u6` WRITE;
/*!40000 ALTER TABLE `u6` DISABLE KEYS */;
/*!40000 ALTER TABLE `u6` ENABLE KEYS */;
UNLOCK TABLES;
