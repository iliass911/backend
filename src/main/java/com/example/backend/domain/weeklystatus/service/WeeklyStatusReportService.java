package com.example.backend.domain.weeklystatus.service;

import com.example.backend.domain.weeklystatus.dto.WeeklyStatusReportDTO;
import com.example.backend.domain.weeklystatus.entity.WeeklyStatusReport;
import com.example.backend.domain.weeklystatus.repository.WeeklyStatusReportRepository;
