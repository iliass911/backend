...
import com.example.backend.domain.preventive_maintenance.mapper.BoardFamilyMapper;
import com.example.backend.domain.preventive_maintenance.repository.BoardFamilyRepository;
